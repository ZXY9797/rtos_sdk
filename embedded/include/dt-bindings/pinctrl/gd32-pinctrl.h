...
#define GD32_APB2_BASE   (GD32_PERIPH_BASE + 0x00010000U)
#define GD32_RCU_BASE    (GD32_PERIPH_BASE + 0x00021000U)
#define GD32_GPIO_BASE   (GD32_APB2_BASE + 0x00000800U)

#define GD32_RCU_APB2EN_ADDR     (GD32_RCU_BASE + 0x18U)
...
#define GD32_PINCTRL_CLOCK(port) \
    PINCTRL_OP(PINCTRL_OP_RMW, GD32_RCU_APB2EN_ADDR, 0U, \
        (1U << ((port) + 2U)))
...
#define GD32_PINCTRL_OUTPUT_LOW(port, pin) \
    PINCTRL_OP(PINCTRL_OP_WRITE, GD32_GPIO_BOP_ADDR(port), 0U, \
               (1U << ((pin) + 16U)))
