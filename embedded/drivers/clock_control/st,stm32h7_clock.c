...
#define SYSCLK_FREQ_MAX		480000000ULL
...
volatile uint32_t dd_vco_freq = 0;
__unused
...
#endif /* STM32_HSE_CSS */
#endif /* IS_ENABLED(STM32_HSE_ENABLED) */
...
#endif /* IS_ENABLED(STM32_HSI_ENABLED) */
...
#endif /* IS_ENABLED(STM32_CSI_ENABLED) */
...
#endif /* IS_ENABLED(STM32_LSI_ENABLED) */
...
#endif /* IS_ENABLED(STM32_LSE_ENABLED) */

#if IS_ENABLED(STM32_HSI48_ENABLED)
	LL_RCC_HSI48_Enable();
	while (LL_RCC_HSI48_IsReady() != 1) {
	}
#endif /* IS_ENABLED(STM32_HSI48_ENABLED) */
}
...
int stm32_clock_control_init(const struct device *dev)
{
	...
	defined(CONFIG_SOC_STM32H7B0XX) || defined(CONFIG_SOC_STM32H7B0XXQ) || \
	defined(CONFIG_SOC_STM32H7B3XX) || defined(SOC_STM32H7B3XXQ)
