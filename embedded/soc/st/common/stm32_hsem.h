...
#if defined(SOC_SERIES_STM32WBX) || defined(STM32H7_DUAL_CORE)
/**
...
#elif defined(SOC_SERIES_STM32MP1x)
...
#endif /* CONFIG_SOC_SERIES_STM32WBX || STM32H7_DUAL_CORE */
...
#endif /* SOC_SERIES_STM32WBX || STM32H7_DUAL_CORE || ... */
}
...
#if defined(CONFIG_SOC_SERIES_STM32WBX) || defined(STM32H7_DUAL_CORE) \
	|| defined(CONFIG_SOC_SERIES_STM32MP1X)
