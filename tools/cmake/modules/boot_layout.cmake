...
foreach(_partition PRELOADER LOADER SLOT0 UPGRADE SCRATCH STORAGE BOOT_CTRL)
...
math(EXPR BOOT_SLOT0_PAYLOAD_ORIGIN
     ...
     OUTPUT_FORMAT HEXADECIMAL)
set(BOOT_APP_IMAGE_SIZE "${BOOT_SLOT0_SIZE}")
if(BOOT_UPGRADE_SIZE LESS BOOT_APP_IMAGE_SIZE)
    set(BOOT_APP_IMAGE_SIZE "${BOOT_UPGRADE_SIZE}")
endif()
math(EXPR BOOT_SLOT0_PAYLOAD_SIZE
     "${BOOT_APP_IMAGE_SIZE} - ${BOOT_IMAGE_HEADER_SIZE}"
     OUTPUT_FORMAT HEXADECIMAL)
...
foreach(_symbol
        ...
        BOOT_SCRATCH_ORIGIN BOOT_SCRATCH_SIZE
